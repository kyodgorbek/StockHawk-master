    ...
    private class StockWidgetViewFactory implements RemoteViewsFactory {
        ...
        public RemoteViews getViewAt(int position) {
           ...
           RemoteViews remoteViews = new RemoteViews(mApplicationContext.getPackageName(),
            ...
            Intent filIntent = new Intent(mApplicationContext, ChartActivity.class);
            filIntent.putExtra(ChartActivity.EXTRA_SYMBOL, symbol);
            remoteViews.setOnClickFillInIntent(R.id.list_item, filIntent);
